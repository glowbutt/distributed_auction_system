...
func (x *GetStateRequest) GetRequesterId() string {
	if x != nil {
...
type GetStateResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Bids           []*BidEntry            `protobuf:"bytes,1,rep,name=bids,proto3" json:"bids,omitempty"`
	AuctionEndTime int64                  `protobuf:"varint,2,opt,name=auction_end_time,json=auctionEndTime,proto3" json:"auction_end_time,omitempty"`
...
func (x *GetStateResponse) GetBids() []*BidEntry {
	if x != nil {
		return x.Bids
	}
	return nil
...
func (x *GetStateResponse) GetAuctionEndTime() int64 {
	if x != nil {
...
func (x *GetStateResponse) GetSequenceNumber() int64 {
	if x != nil {
		return x.SequenceNumber
	}
	return 0
...
const file_proto_proto_rawDesc = "" +
	...
	"\tbidder_id\x18\x01 \x01(\tR\bbidderId\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x05R\x06amount\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp\"\x8c\x01\n" +
	"\x10GetStateResponse\x12%\n" +
	"\x04bids\x18\x01 \x03(\v2\x11.auction.BidEntryR\x04bids\x12(\n" +
	"\x10auction_end_time\x18\x02 \x01(\x03R\x0eauctionEndTime\x12'\n" +
	"\x0fsequence_number\x18\x03 \x01(\x03R\x0esequenceNumber\"-\n" +
	...
	"\x06Result\x12\x16.auction.ResultRequest\x1a\x17.auction.ResultResponse2\xb2\x02\n" +
	"\vReplication\x12N\n" +
	...
	"\fReplicateBid\x12\x1c.auction.ReplicateBidRequest\x1a\x1d.auction.ReplicateBidResponse\x12?\n" +
	"\bGetState\x12\x18.auction.GetStateRequest\x1a\x19.auction.GetStateResponseB\x16Z\x14auction-system/protob\x06proto3"
...
var file_proto_proto_goTypes = []any{
	...
	(*GetStateRequest)(nil),       // 7: auction.GetStateRequest
	(*BidEntry)(nil),              // 8: auction.BidEntry
	(*GetStateResponse)(nil),      // 9: auction.GetStateResponse
	(*RemovePeerRequest)(nil),     // 10: auction.RemovePeerRequest
	(*RemovePeerResponse)(nil),    // 11: auction.RemovePeerResponse
	(*MakeNewLeaderRequest)(nil),  // 12: auction.MakeNewLeaderRequest
	(*MakeNewLeaderResponse)(nil), // 13: auction.MakeNewLeaderResponse
}
var file_proto_proto_depIdxs = []int32{
	0,  // 0: auction.BidResponse.status:type_name -> auction.BidResponse.Status
	8,  // 1: auction.GetStateResponse.bids:type_name -> auction.BidEntry
	1,  // 2: auction.Auction.Bid:input_type -> auction.BidRequest
	3,  // 3: auction.Auction.Result:input_type -> auction.ResultRequest
	12, // 4: auction.Replication.MakeNewLeader:input_type -> auction.MakeNewLeaderRequest
	10, // 5: auction.Replication.RemovePeer:input_type -> auction.RemovePeerRequest
	5,  // 6: auction.Replication.ReplicateBid:input_type -> auction.ReplicateBidRequest
	7,  // 7: auction.Replication.GetState:input_type -> auction.GetStateRequest
	2,  // 8: auction.Auction.Bid:output_type -> auction.BidResponse
	4,  // 9: auction.Auction.Result:output_type -> auction.ResultResponse
	13, // 10: auction.Replication.MakeNewLeader:output_type -> auction.MakeNewLeaderResponse
	11, // 11: auction.Replication.RemovePeer:output_type -> auction.RemovePeerResponse
	6,  // 12: auction.Replication.ReplicateBid:output_type -> auction.ReplicateBidResponse
	9,  // 13: auction.Replication.GetState:output_type -> auction.GetStateResponse
